...
append_list = [] # here space allocated for the list is 1
...
# But some operation don't increase size & some do, so while we average it out. It has constant space complexity: Amortized Constant Space Complexity

# Resize happens with resize too, but it is more expensive because after every insert every element needs to be shifted 1
