...
"""
"Top Notebooks of the Week".
Write a function to sort a list of notebooks in decreasing order of likes. Keep in mind that up to millions of notebooks can be created every week, so your function needs to be as efficient as possible.
"""
...
sorted_notebooks_by_likes = merge_sort(notebooks, compare_likes)

sorted_notebooks_by_titles = merge_sort(notebooks, compare_titles)
